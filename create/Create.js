...
const Create = (props) => {
    ...
    const createFormData = () => {
        ...
        formData.append('post_image', uploadPostImage);
            ...
            <div className='create-post__content'>
                <div className='create-post__container'>
                    ...
                    <div className='create-post__close'>
                        <img src='https://static.xx.fbcdn.net/rsrc.php/v3/y2/r/__geKiQnSG-.png' onClick={toggleModal(false)} alt='close'/>
                    </div>
                </div>
                ...
                <div className='create-post__form'>
                    ...
                    {!postImage && <div onClick={() => filePickerRef.current.click()} className='create-post__image-picker'>
                        <svg aria-label="Icon to represent media such as images or videos" className="_8-yf5 " color="#262626" fill="#262626" height="77" role="img" viewBox="0 0 97.6 77.3" width="96">
                        ...
                        <p>Uplaod photos and videos here</p>
                        </div>}
                        <input 
                        style={{display: 'none'}}
