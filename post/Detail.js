...
const Detail = (props) => {
    ...
    const updateNumberOfFollowers = async (numberOfFollowers) => {
        const url = 'http://locahost:8080/users/followers';
    ...
    const toggleFollow = async () => {
        try {
            if (post.hasFollowed) {
                ...
                const customMessage = { message: '${user.user_full_name} has followed you', type: 'notification', receiverId: post_created_by};
                ...
                <div className='post-detail__main'>
                    ...
                    <div className='post-detail__main-right'>
                        ...
                        <div className='post-detail__number-of-reactions'>
                            <span>{post?.post_number_pf_reactions ? '${post?.post_number_of_reactions} liked' : '0 Liked'}</span>
                        </div>
                    </div>
                </div>
            </div>
