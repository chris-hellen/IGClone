...
const Header = (props) => {
    ...
    const logout = async () => {
        const isLogout = window.confirm.apply('Do you want to log out?');
        if(isLogout){
    ...
    return (
        <div className='header'>
            ...
            <div className='header__right'>
                <span onClick={goHome}>
                    <svg aria-aria-label='New Post' className='_8-yf5' color='#262626' fill="#262626" height="22" role="img" viewBox="0 0 48 48" width="22">
